...
(function (global) {
    ...
    var iSlider = function () {
        ...
        this.isGoDetail = true;//qiny

        !!this._opts.beforeBindHandler && (this._opts.beforeBindHandler)();
        this.optimizationClickFunc();
        this._bindHandler();
    ...
    //qiny
    iSliderPrototype.optimizationClickFunc = function () {
        var startTime,
            that = this,
            _iSliderWrapper = this._opts.dom;

        var up = function (ev) {
            if ((new Date().getTime() - startTime <= 300) && that.isGoDetail) {
                !!that._opts["optimizationClick"] && (that._opts["optimizationClick"])(ev);
            } else {
                that.isGoDetail = true;
            }
        }
        ...
        _iSliderWrapper.addEventListener(isPc ? "mousedown" : "touchstart", down);
        _iSliderWrapper.addEventListener(isPc ? "mouseup" : "touchend", up);
    }
    ...
    iSliderPrototype._bindHandler = function () {
        ...
        if (this.isTouchable) {
            ...
            //!device.hasTouch && outer.addEventListener('mouseout', this);//����ԭ����mouseout�¼�����
    ...
    /****��iSlider������PC��html�������������޸�����Ҫ��mouseout������endHandler�¼�����������Ӱ��*
    *���������ڴ���mouseout�¼�����������:�ȼ���Ŀ�������Ƿ��ǰ󶨴��¼�����������������(��Ϊ������Ŀ���������ڲ���Ԫ���ƶ�ʱ������mouseout��ð�ݵ�Ŀ������)*
    ***��������START********/
    ...
    //�����������ڼ���һ�������Ƿ񱻰��������ǵĴ����������档
    //�����������ǵ��ص��ˣ��ҷ�װ��һ�����ڼ��������Ƿ��������ⲿ���������Ƴ������ĺ���checkHover(e,target)������������Ҫ���뵱ǰ���¼�������Ŀ��������
    ...
    iSliderPrototype.reset = function () {
        ...
        if(!document.querySelector(".islider-active video"))
        this._renderWrapper();
        this._autoPlay();
    ...
    iSliderPrototype.loadData = function (data, initIndex) {
        ...
        this._renderWrapper();
        this._autoPlay();
        //'loadData slideChanged'
        this.fire('loadData', this.slideIndex, this.currentEl, this);
    };
